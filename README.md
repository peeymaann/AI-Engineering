...
| Week | Topic                                                    | Depth        | Status      |
| ---- | -------------------------------------------------------- | ------------ | ----------- |
| 1    | Chat + Vercel AI SDK + Ollama / Grok                     | Full         | ✅ Done     |
| 2    | UI + Pinia + history + Git                               | Full         | ✅ Done     |
| 3    | RAG + Embedding + PDF + Nest + API switch                | Full         | ✅ Done     |
| 4    | Tool Calling + one simple Agent                          | Full         | 🔜 Next     |
| 5    | Very simple Multi-Agent (Researcher / Writer / Reviewer) | Light        | Later       |
| 6    | Small IoT AI Dashboard                                   | Medium       | Later       |
| 7    | Short Auth + conceptual Observability (Langfuse)         | Introduction | Later       |
| 8    | Deploy + final README                                    | Full         | Last        |
